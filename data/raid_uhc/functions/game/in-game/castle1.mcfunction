...
execute store result score @e[type=armor_stand,name="castle",limit=1] raid.x run data get entity @s Pos[0]
execute store result score @e[type=armor_stand,name="castle",limit=1] raid.y run data get entity @s Pos[1]
execute store result score @e[type=armor_stand,name="castle",limit=1] raid.z run data get entity @s Pos[2]
