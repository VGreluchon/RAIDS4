...
#elim joueur
execute as @s run function raid_uhc:game/in-game/dropinv
...
execute if score #nteam raid.data matches 1 as @a[team=raid.team.3,scores={raid.death=0}] run tellraw @a ["",{"text":"L'équipe ","color":"aqua"},{"text":"3","color":"gold"},{"text":" a remporté cette partie de RAID V4 !\nGG à ","color":"aqua"},{"selector":"@a[team=raid.team3]","color":"gold"}]
execute if score #nteam raid.data matches 1 as @a[team=raid.team.4,scores={raid.death=0}] run tellraw @a ["",{"text":"L'équipe ","color":"aqua"},{"text":"4","color":"gold"},{"text":" a remporté cette partie de RAID V4 !\nGG à ","color":"aqua"},{"selector":"@a[team=raid.team4]","color":"gold"}]
execute if score #nteam raid.data matches 1 as @a[team=raid.team.5,scores={raid.death=0}] run tellraw @a ["",{"text":"L'équipe ","color":"aqua"},{"text":"5","color":"gold"},{"text":" a remporté cette partie de RAID V4 !\nGG à ","color":"aqua"},{"selector":"@a[team=raid.team5]","color":"gold"}]
execute if score #nteam raid.data matches 1 as @a[team=raid.team.6,scores={raid.death=0}] run tellraw @a ["",{"text":"L'équipe ","color":"aqua"},{"text":"6","color":"gold"},{"text":" a remporté cette partie de RAID V4 !\nGG à ","color":"aqua"},{"selector":"@a[team=raid.team6]","color":"gold"}]
execute if score #nteam raid.data matches 1 as @a[team=raid.team.7,scores={raid.death=0}] run tellraw @a ["",{"text":"L'équipe ","color":"aqua"},{"text":"7","color":"gold"},{"text":" a remporté cette partie de RAID V4 !\nGG à ","color":"aqua"},{"selector":"@a[team=raid.team7]","color":"gold"}]
execute if score #nteam raid.data matches 1 as @a[team=raid.team.8,scores={raid.death=0}] run tellraw @a ["",{"text":"L'équipe ","color":"aqua"},{"text":"8","color":"gold"},{"text":" a remporté cette partie de RAID V4 !\nGG à ","color":"aqua"},{"selector":"@a[team=raid.team8]","color":"gold"}]
