...
give @a[scores={raid.skinwalkers=3}] leather_chestplate{Unbreakable:1,Enchantments:[{id:"protection",lvl:4}],display:{color:11546150,Name:'[{"text":"Taurus Chesplate","italic":false}]',Lore:['[{"text":"RAID ","italic":false,"color":"red"},{"text":"V4","color":"gold"}]']}} 1

give @a[scores={raid.barbarians=3}] elytra{Enchantments:[{id:"protection",lvl:5},{id:"unbreaking",lvl:1}]} 1
give @a[scores={raid.barbarians=3}] firework_rocket 64
