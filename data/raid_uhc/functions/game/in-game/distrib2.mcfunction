execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.bannerlords 1
...
execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.highelves 1
...
execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.sacredorder 1
...
execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.barbarians 1
...
execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.ogryntribes 1
...
execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.shadowkin 1
...
execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.skinwalkers 1
...
execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.demonspawn 1
...
execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.dwarves 1
...
execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.undeadhordes 1
...
execute as @r[scores={raid.start=1}] run scoreboard players set @s raid.orcs 1
...
function raid_uhc:game/in-game/distrib3
