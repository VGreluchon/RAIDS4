...
#Lorsque sa vie passe en dessous de 7.5♥, il inflige des dégâts à l’adversaire le plus proche, si son adversaire a moins de 7.5♥, celui ci est ralenti pendant 10 secondes (5 minutes de récupération)
...
#Il possède un glaive, tous les 4 coups donnés avec celui ci, son prochain coups inflige un effet de poison pendant 3 secondes
#dans advancements
