...
execute at @a[distance=1..20] unless score @s raid.bannerlords matches 1..2 as @a[scores={raid.bannerlords=3}] run attribute @s minecraft:generic.attack_damage modifier add 1-1-1-1-1 "uwu20" 0.15 multiply_base
