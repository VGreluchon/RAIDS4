...
execute if score @s[scores={raid.spell=1..}] raid.cooldown matches ..14 run scoreboard players set @s raid.spell 0
...
execute if score @s raid.stat matches 1.. run title @s actionbar ["",{"text":"Frog shifter: ","color":"#0F6FD8"},{"text":"2 formes activées","color":"gold"}]
