...
#31-80% pas d’effet
#81-100% = Faiblesse 1
execute if score @s raid.stat matches 71..100 run effect give @s weakness 2 0 true
...
execute if score @s raid.stat matches 31..70 run title @s actionbar ["",{"text":"Energy King: ","color":"#0F6FD8"},{"text":"No Effect","color":"#0F6FD8"},{"text":" |Hang glider: ","color":"#0F6FD8"},{"score":{"name":"@s","objective":"raid.stat"},"color":"gold"},{"text":"%","color":"#0F6FD8"}]
execute if score @s raid.stat matches 71..100 run title @s actionbar ["",{"text":"Energy King: ","color":"#0F6FD8"},{"text":"Weakness I","color":"#0F6FD8"},{"text":" |Hang glider: ","color":"#0F6FD8"},{"score":{"name":"@s","objective":"raid.stat"},"color":"gold"},{"text":"%","color":"#0F6FD8"}]
