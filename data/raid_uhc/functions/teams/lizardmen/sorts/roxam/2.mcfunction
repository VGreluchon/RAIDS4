...
execute as @a[distance=..10,scores={raid.lizardmen=0}] run effect give @s jump_boost 3 101 true
execute as @a[distance=..10,scores={raid.lizardmen=0}] run effect give @s nausea 10 0 true
execute as @a[distance=..10,scores={raid.lizardmen=0}] run playsound minecraft:entity.wither.death player @a ~ ~ ~
execute as @a[distance=..10,scores={raid.lizardmen=0}] run playsound minecraft:entity.wither.death player @a ~ ~ ~
execute as @a[distance=..10,scores={raid.lizardmen=0}] run playsound minecraft:entity.wither.death player @a ~ ~ ~
execute as @a[distance=..10,scores={raid.lizardmen=0}] run playsound minecraft:entity.wither.death player @a ~ ~ ~
