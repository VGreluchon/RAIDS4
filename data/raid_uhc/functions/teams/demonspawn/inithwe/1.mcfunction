...
execute if entity @a[scores={raid.demonspawn=1},distance=..10] run attribute @s minecraft:generic.attack_damage modifier add 1-1-1-1-1 "uwu20" 0.20 multiply_base
execute if entity @a[scores={raid.demonspawn=1},distance=11..] run attribute @s minecraft:generic.attack_damage modifier remove 1-1-1-1-1
