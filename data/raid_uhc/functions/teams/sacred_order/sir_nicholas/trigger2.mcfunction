...
execute if entity @s[scores={raid.stat=60..},tag=!raid.elytra] run give @s elytra{Unbreakable:1,Enchantments:[{id:"protection",lvl:5}]} 1
execute if entity @s[scores={raid.stat=60..},tag=!raid.elytra] run give @s firework_rocket 10
execute if entity @s[scores={raid.stat=60..},tag=!raid.elytra] run scoreboard players remove @s load.stat 60
