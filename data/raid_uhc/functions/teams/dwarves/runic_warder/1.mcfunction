...
execute if score @s[scores={raid.spell=1..}] raid.cooldown matches 0..44 as @a[name="RabbitBeacon"] run function raid_uhc:teams/dwarves/runic_warder/3
execute if score @s[scores={raid.spell=1..}] raid.cooldown matches 45 as @a[name="RabbitBeacon"] run function raid_uhc:teams/dwarves/runic_warder/4
