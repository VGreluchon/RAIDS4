...
execute at @a[scores={raid.sacredorder=1}] run tp @e[type=armor_stand,name="1"] ~ -20 ~
execute at @a[scores={raid.sacredorder=2}] run tp @e[type=armor_stand,name="2"] ~ -20 ~
execute at @a[scores={raid.sacredorder=3}] run tp @e[type=armor_stand,name="3"] ~ -20 ~
execute as @e[type=armor_stand,name="1"] run effect give @a[scores={raid.sacredorder=1},distance=..50] haste 3 0 true
