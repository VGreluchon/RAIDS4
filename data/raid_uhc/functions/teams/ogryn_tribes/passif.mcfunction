...
execute as @a[scores={raid.sacredorder=1}] run tp @e[type=armor_stand,tag=1] @s
tp @e[type=armor_stand,tag=1] ~ -20 ~
execute as @a[scores={raid.sacredorder=2}] run tp @e[type=armor_stand,tag=2] @s
tp @e[type=armor_stand,tag=2] ~ -20 ~
execute as @a[scores={raid.sacredorder=3}] run tp @e[type=armor_stand,tag=3] @s
tp @e[type=armor_stand,tag=3] ~ -20 ~
