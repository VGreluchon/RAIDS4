...
execute store result score @a[scores={raid.highelves=10},limit=1] raid.y run data get entity @s Pos[1]
execute store result score @a[scores={raid.highelves=10},limit=1] raid.z run data get entity @s Pos[2]
