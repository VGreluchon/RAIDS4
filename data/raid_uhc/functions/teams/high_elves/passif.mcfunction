...
execute if score #day raid.data matches 0..300 as @a[distance=..30,scores={raid.highelves=10}] unless entity @s[scores={raid.shadowkin=1..3}] run effect give @s glowing 2 0 true