execute unless score @s raid.skinwalkers matches 3 run effect give @s minecraft:regeneration 16 1 true
execute if score @s raid.skinwalkers matches 3 run effect give @s minecraft:regeneration 8 2 true
...
advancement revoke @s only raid_uhc:technical/ate_golden_head