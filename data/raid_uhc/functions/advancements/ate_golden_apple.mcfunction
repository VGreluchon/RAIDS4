...
execute if entity @s[scores={raid.darkelves=1..3}] run effect give @a[distance=1..,scores={raid.darkelves=1..3}] regeneration 3 1 true
execute if entity @s[scores={raid.undeadhordes=1..3}] run effect give @a[distance=1..,scores={raid.undeadhordes=1..3}] regeneration 3 1 true
