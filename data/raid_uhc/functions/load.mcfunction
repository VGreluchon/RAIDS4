...
#Items
		...
		data modify storage raid_uhc:main all.claw set value {Slot:16b							,id:"minecraft:netherite_sword"				,Count:1b,tag:{ctc:{id:"claw",from:"vgreluchon:raid_uhc",traits:{"tool/weapon":1b}},RepairCost:40,Unbreakable:1b										,CustomModelData:4229004,raid_uhc:{claw:1b}								,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"mainhand",Amount:3.0d,Operation:0,UUID:[I;201305,201305,201305,500005]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Slot:"mainhand",Amount:-0.5d,Operation:0,UUID:[I;201305,201305,201305,500006]}]							,display:{Lore:['[{"translate":"RAID","color":"red","italic":true},{"translate":" V4","color":"gold","italic":true}]'],Name:'[{"text":"Claw","italic":false,"color":"white"}]'}}}
