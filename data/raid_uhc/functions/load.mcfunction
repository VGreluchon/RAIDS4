...
#Items
		...
		data modify storage raid_uhc:main all.crown set value {Slot:16b							,id:"minecraft:golden_helmet"				,Count:1b,tag:{ctc:{id:"crown",from:"vgreluchon:raid_uhc",traits:{"armor":1b}},RepairCost:40,Unbreakable:1b,Enchantments:[{id:"protection",lvl:2}]		,CustomModelData:4229007,raid_uhc:{crown:1b}						,HideFlags:64,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Slot:"head",Amount:3.0d,Operation:0,UUID:[I;201305,201305,201305,500009]}	,{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Slot:"head",Amount:1.0d,Operation:0,UUID:[I;201305,201305,201305,500010]},{AttributeName:"generic.attack_damage",Amount:0.1,Slot:"head",Operation:1,Name:"generic.attack_damage",UUID:[I;-12361,30944,175816,-61888]},{AttributeName:"generic.movement_speed",Amount:0.1,Slot:"head",Operation:1,Name:"generic.movement_speed",UUID:[I;-12361,31044,175816,-62088]} ]										,display:{Lore:['[{"translate":"RAID","color":"red","italic":true},{"translate":" V4","color":"gold","italic":true}]']	,Name:'[{"text":"Crown","italic":false,"color":"white"}]'}}}
