...
scoreboard objectives add raid.castle dummy
...
#Items
		...
		data modify storage raid_uhc:main all.obsidian_sword set value {Slot:16b				,id:"minecraft:netherite_sword"				,Count:1b,tag:{ctc:{id:"obsidian_sword",from:"vgreluchon:raid_uhc",traits:{"tool/weapon":1b}},RepairCost:40												,CustomModelData:4229002,raid_uhc:{obsidian:1b,obsidian_sword:1b}		,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"mainhand",Amount:9.0d,Operation:0,UUID:[I;201305,201305,201305,500001]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Slot:"mainhand",Amount:-2.5d,Operation:0,UUID:[I;201305,201305,201305,500004]}]																																										,display:{Lore:['[{"translate":"RAID","color":"red","italic":true},{"translate":" V4","color":"gold","italic":true}]'],Name:'[{"text":"Obsidian Sword","italic":false,"color":"white"}]'}}}
		data modify storage raid_uhc:main all.glaive set value {Slot:16b						,id:"minecraft:netherite_sword"				,Count:1b,tag:{ctc:{id:"glaive",from:"vgreluchon:raid_uhc",traits:{"tool/weapon":1b}},RepairCost:40														,CustomModelData:4229003,raid_uhc:{glaive:1b}							,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"mainhand",Amount:9.0d,Operation:0,UUID:[I;201305,201305,201305,500003]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Slot:"mainhand",Amount:-2.5d,Operation:0,UUID:[I;201305,201305,201305,500005]}]																																										,display:{Lore:['[{"translate":"RAID","color":"red","italic":true},{"translate":" V4","color":"gold","italic":true}]'],Name:'[{"text":"Glaive","italic":false,"color":"white"}]'}}}
		data modify storage raid_uhc:main all.claw set value {Slot:16b							,id:"minecraft:netherite_sword"				,Count:1b,tag:{ctc:{id:"claw",from:"vgreluchon:raid_uhc",traits:{"tool/weapon":1b}},RepairCost:40,Unbreakable:1b										,CustomModelData:4229004,raid_uhc:{claw:1b}								,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"mainhand",Amount:4.0d,Operation:0,UUID:[I;201305,201305,201305,500005]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Slot:"mainhand",Amount:-0.5d,Operation:0,UUID:[I;201305,201305,201305,500006]}]							,display:{Lore:['[{"translate":"RAID","color":"red","italic":true},{"translate":" V4","color":"gold","italic":true}]'],Name:'[{"text":"Claw","italic":false,"color":"white"}]'}}}
		data modify storage raid_uhc:main all.galek_axe set value {Slot:16b						,id:"minecraft:netherite_axe"				,Count:1b,tag:{ctc:{id:"galek_axe",from:"vgreluchon:raid_uhc",traits:{"tool/weapon":1b}},RepairCost:40													,CustomModelData:4229005,raid_uhc:{galek_axe:1b}						,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"mainhand",Amount:10.5d,Operation:0,UUID:[I;201305,201305,201305,500007]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Slot:"mainhand",Amount:-3.1d,Operation:0,UUID:[I;201305,201305,201305,500007]}]																																											,display:{Lore:['[{"translate":"RAID","color":"red","italic":true},{"translate":" V4","color":"gold","italic":true}]'],Name:'[{"text":"Galek Axe","italic":false,"color":"white"}]'}}}
		...
		data modify storage raid_uhc:main all.crown set value {Slot:16b							,id:"minecraft:golden_helmet"				,Count:1b,tag:{ctc:{id:"crown",from:"vgreluchon:raid_uhc",traits:{"armor":1b}},RepairCost:40,Unbreakable:1b,Enchantments:[{id:"protection",lvl:4}]		,CustomModelData:4229007,raid_uhc:{crown:1b}						,HideFlags:64,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Slot:"head",Amount:3.0d,Operation:0,UUID:[I;201305,201305,201305,500009]}	,{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Slot:"head",Amount:1.0d,Operation:0,UUID:[I;201305,201305,201305,500010]},{AttributeName:"generic.attack_damage",Amount:0.1,Slot:"head",Operation:1,Name:"generic.attack_damage",UUID:[I;-12361,30944,175816,-61888]},{AttributeName:"generic.movement_speed",Amount:0.1,Slot:"head",Operation:1,Name:"generic.movement_speed",UUID:[I;-12361,31044,175816,-62088]} ]										,display:{Lore:['[{"translate":"RAID","color":"red","italic":true},{"translate":" V4","color":"gold","italic":true}]']	,Name:'[{"text":"Crown","italic":false,"color":"white"}]'}}}
