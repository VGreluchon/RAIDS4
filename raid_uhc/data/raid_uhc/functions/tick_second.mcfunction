...
#Timer
	...
	execute if score #started raid.data matches 1.. as @r run function raid_uhc:game/in-game/timer
	execute if score #started raid.data matches 1.. as @r run function raid_uhc:game/in-game/bordertime
	execute if score #started raid.data matches 1.. as @r run function raid_uhc:game/in-game/border
#Others
	execute if score #started raid.data matches 1.. as @a[sort=random] at @s run function raid_uhc:game/players_seconds
	...
	execute as @a run function raid_uhc:game/in-game/hastedboys