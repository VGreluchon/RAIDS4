...
execute if score @s raid.cooldown matches ..10 run title @s actionbar ["",{"text":"Shield riposte:","color":"#0F6FD8"},{"score":{"name":"@s","objective":"raid.cooldown"},"color":"gold"},{"text":"/10","color":"#0F6FD8"}]
execute if score @s raid.cooldown matches 10.. run title @s actionbar ["",{"text":"Shield riposte: ","color":"#0F6FD8"},{"text":"Capacité prête","color":"gold"}]