...
execute if score @s[scores={sacred_order=1}] raid.cooldown matches ..239 run title @s actionbar ["",{"text":"Blinding beauty: ","color":"#0F6FD8"},{"score":{"name":"@s","objective":"raid.cooldown"},"color":"gold"},{"text":"/240","color":"#0F6FD8"}]
execute if score @s[scores={sacred_order=1}] raid.cooldown matches 240.. run title @s actionbar ["",{"text":"Blinding beauty: ","color":"#0F6FD8"},{"text":"Ready","color":"gold"}]