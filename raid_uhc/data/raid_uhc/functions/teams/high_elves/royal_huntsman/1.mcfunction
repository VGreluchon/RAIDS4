...
execute if score @s raid.highelves matches 1 run function raid_uhc:teams/high_elves/royal_huntsman/2
data modify entity @s SelectedItem.tag.LodestonePos.X set from storage raid_uhc:main TrackedPlayerPos
data modify entity @s SelectedItem.tag.LodestonePos.Y set from storage raid_uhc:main TrackedPlayerPos
data modify entity @s SelectedItem.tag.LodestonePos.Z set from storage raid_uhc:main TrackedPlayerPos
