...
execute as @e[type=arrow,tag=lighting_bolt,nbt={inGround:1b}] run function raid_uhc:teams/high_elves/jinglehunter/4
execute as @e[type=marker,predicate=!raid_uhc:ride,tag=raid.arrow] run function raid_uhc:teams/high_elves/jinglehunter/4
