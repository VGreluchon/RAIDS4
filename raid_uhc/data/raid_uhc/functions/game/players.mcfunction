...
execute as @s[scores={raid.ogryntribes=3}] run function raid_uhc:teams/ogryn_tribes/skullcrusher/1

execute as @s[scores={raid.lizardmen=1}] run function raid_uhc:teams/lizardmen/passifs/dracomorph/1
execute as @s[scores={raid.lizardmen=2}] run function raid_uhc:teams/lizardmen/passifs/skulllord/1
execute as @s[scores={raid.lizardmen=3}] run function raid_uhc:teams/lizardmen/passifs/quargan/1
execute as @s[scores={raid.lizardmen2=1}] run function raid_uhc:teams/lizardmen/sorts/ba_satha/1
execute as @s[scores={raid.lizardmen2=2}] run function raid_uhc:teams/lizardmen/sorts/roxam/1
execute as @s[scores={raid.lizardmen2=3}] run function raid_uhc:teams/lizardmen/sorts/drake/1

execute as @s[scores={raid.shadowkin=1}] run function raid_uhc:teams/shadowkin/toragi/1
execute as @s[scores={raid.shadowkin=2}] run function raid_uhc:teams/shadowkin/ninja/1
execute as @s[scores={raid.shadowkin=3}] run function raid_uhc:teams/shadowkin/life_taker/1

execute as @s[scores={raid.skinwalkers=1}] run function raid_uhc:teams/skinwalkers/brakus/1
...
execute as @s[scores={raid.orcs=3}] run function raid_uhc:teams/orcs/spikehead/1

execute as @s[scores={raid.knightsrevenant=1}] run function raid_uhc:teams/knight_revenant/crypt_witch/1
